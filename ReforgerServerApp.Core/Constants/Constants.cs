 ...
 * 
 * Author:       Bradley Newman, Ben Fleuty
 ******************************************************************************/
...
namespace ReforgerServerApp.Core
{
    ...
    public static class Constants
    {
        ...
        public const string ERROR_MESSAGEBOX_TITLE_STR = "Arma Reforger Dedicated Server Tool - Error";
        public const string WARN_MESSAGEBOX_TITLE_STR = "Arma Reforger Dedicated Server Tool - Warning";
        public const string INFO_MESSAGEBOX_TITLE_STR = "Arma Reforger Dedicated Server Tool - Information";
        ...
        public const string START_SERVER_STR = "Start Server";
        public const string STOP_SERVER_STR = "Stop Server";
        ...
        public const string MIGRATE_LEGACY_MOD_DB_PROMPT_STR = "A mod database from a previous version of the Arma Reforger Dedicated Server Tool was found.\r\n\r\n" +
